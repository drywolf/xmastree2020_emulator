def xmaslight():
    ...
    pixels = neopixel.NeoPixel(123, PIXEL_COUNT, auto_write=False)
    ...
    def runLoop():
        nonlocal swap01, swap02, c, angle, coords, colourA, colourB, direction
        # time.sleep(slow)
    ...
    timer.set_interval(runLoop, 50)
    # timer.request_animation_frame(runLoop)
